...
Step 2) Open your /src/Application.php and add the UrlConsistenceMiddleware to your middleware queue but make sure that it is placed immediately after the RoutingMiddleware.
